...
app_jogada_jogador = Label(frame_baixo, height=1, text="",  anchor="center", bg=cor0, font="Ivy 10 bold")
app_jogada_jogador.place (x=10, y=10)

app_jogada_jogadorpc = Label(frame_baixo, height=1, text="",  anchor="center", bg=cor0, font="Ivy 10 bold")
app_jogada_jogadorpc.place (x=190, y=10)

app_empate = Label(frame_baixo, text="", width=255, anchor="center", bg=cor3, font="Ivy 1 bold")
app_empate.place (x=0, y=4)
...
btn_pedra = Button(frame_baixo, command=lambda:jogar("pedra"), width=50, height=50, image=icone_pedra, bg=cor0, fg=cor0, compound="center")
...
btn_papel = Button(frame_baixo, command=lambda:jogar("papel"), width=50, height=50, image=icone_papel, bg=cor0, fg=cor0, compound="center")
...
btn_tesoura = Button(frame_baixo, command=lambda:jogar("tesoura"), width=50, height=50, image=icone_tesoura, bg=cor0,fg=cor0, compound="center" )
